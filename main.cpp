...
void NhanSP (Sophuc sp1, Sophuc sp2)
{
    ...
    tichao = sp1.phanthuc*sp2.phanao + sp1.phanao*sp2.phanthuc;
...
void ChiaSP (Sophuc sp1, Sophuc sp2)
{
    ...
    cout << "Thuong: " << round(thuongthuc) << " + " << round(thuongao) << "i" << endl;
}

void Compute (Sophuc sp)
{
    float ketqua = 0;
    ketqua = sqrt(pow(sp.phanthuc,2)+ pow(sp.phanao,2));
    cout << "Compute Module : " << ketqua << endl;
}
